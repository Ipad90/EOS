	...
	<body>
		...
		<table align = "center">
			<tr>
				<th>	
					<?PHP
						...
						echo '<a href = "pedro_product_1.php">';
				...
				<th>
					<?PHP
						$SQL_2 = "SELECT Shoe_Image FROM shoes WHERE Shoe_ID = 37";
						$b = $db_found -> query($SQL_2);
						$result_2 = mysqli_fetch_array($b);
						echo '<a href = "pedro_product_2.php">';
						echo "<img src = 'Shoe/".$result_2['Shoe_Image']."'>";
					?>
				</th>
			</tr>
			...
			<tr>
				<th><p>
					<?PHP 
						$SQL_3 = "SELECT Shoe_Name FROM shoes WHERE Shoe_ID = 33";
				...
				<th><p>
					<?PHP 
						$SQL_4 = "SELECT Shoe_Name FROM shoes WHERE Shoe_ID = 37";
			...
			<tr>
				<th>
					<?PHP
						$SQL_2 = "SELECT Shoe_Image FROM shoes WHERE Shoe_ID = 41";
						$b = $db_found -> query($SQL_2);
						$result_2 = mysqli_fetch_array($b);
						echo '<a href = "pedro_product_3.php">';
						echo "<img src = 'Shoe/".$result_2['Shoe_Image']."'>";
					?>
				</th>
				...
				<th>
					<?PHP
						$SQL_2 = "SELECT Shoe_Image FROM shoes WHERE Shoe_ID = 45";
						$b = $db_found -> query($SQL_2);
						$result_2 = mysqli_fetch_array($b);
						echo '<a href = "pedro_product_4.php">';
						echo "<img src = 'Shoe/".$result_2['Shoe_Image']."'>";
					?>
				</th>
			</tr>
			...
			<tr>
				<th><p>
					<?PHP 
						$SQL_3 = "SELECT Shoe_Name FROM shoes WHERE Shoe_ID = 41";
						$c = $db_found -> query($SQL_3);
						$result_3 = mysqli_fetch_array($c);
						echo $result_3['Shoe_Name'];
					?>
				...
				<th><p>
					<?PHP 
						$SQL_4 = "SELECT Shoe_Name FROM shoes WHERE Shoe_ID = 45";
						$d = $db_found -> query($SQL_4);
						$result_4 = mysqli_fetch_array($d);
						echo $result_4['Shoe_Name'];
					?>

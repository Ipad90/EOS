<?PHP
	...
	if (isset($_SESSION['login'])) {
		...
		if (isset($_POST['add_cart'])) {
			switch ($_POST['size']) {
				case '8':
					$query_1 = "INSERT INTO shopping_cart (Date_Added, User_ID, Shoe_ID) VALUES (now(), '$current_user', '1')";
					mysqli_query($db_found, $query_1);
					break;
				case '9':
					$query_2 = "INSERT INTO shopping_cart (Date_Added, User_ID, Shoe_ID) VALUES (now(), '$current_user', '2')";
					mysqli_query($db_found, $query_2);
					break;
				case '10':
					$query_3 = "INSERT INTO shopping_cart (Date_Added, User_ID, Shoe_ID) VALUES (now(), '$current_user', '3')";
					mysqli_query($db_found, $query_3);
					break;
				case '11':
					$query_4 = "INSERT INTO shopping_cart (Date_Added, User_ID, Shoe_ID) VALUES (now(), '$current_user', '4')";	
					mysqli_query($db_found, $query_4);
					break;
				case '0':
					header ('location: aldo_product_1.php');
					break;
			}
		}
		...
		if (isset($_POST['add_wishlist'])) {
			switch ($_POST['size']) {
				case "8":
					$query_5 = "INSERT INTO wishlist (User_ID, Shoe_ID) VALUES ('$current_user', '1')";
					mysqli_query($db_found, $query_5);
					break;
				case "9":
					$query_6 = "INSERT INTO wishlist (User_ID, Shoe_ID) VALUES ('$current_user', '2')";
					mysqli_query($db_found, $query_6);
					break;
				case "10":
					$query_7 = "INSERT INTO wishlist (User_ID, Shoe_ID) VALUES ('$current_user', '3')";
					mysqli_query($db_found, $query_7);
					break;
				case "11":
					$query_8 = "INSERT INTO wishlist (User_ID, Shoe_ID) VALUES ('$current_user', '4')";
			...
			<div class = "w3-row w3-padding-32" id="about">
				<div class = "w3-col m6 w3-padding-large w3-half">
					<?PHP
						...
						$SQL_2 = "SELECT Shoe_Image FROM shoes WHERE Shoe_ID = 2";
				...
				<div class = "w3-col m6 w3-padding-large w3-half w3-container">
					<?PHP
						$SQL_3 = "SELECT * FROM shoes WHERE Shoe_ID = 1";
					...
					<form method = "post" action = "aldo_product_1.php"> 
